...
// Duplication pour l'effet infini (x2 est souvent suffisant si le contenu dépasse la largeur de l'écran, 
// mais x4 assure une fluidité sur les très grands écrans 4K)
